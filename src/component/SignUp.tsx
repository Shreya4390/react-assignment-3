...
import '../App.css';
import { options, headers, todayDate } from '../utils/constant';
...
export default class SignUp extends Component<Props, State> {
  ...
  handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    profile = profile ? profile : 'https://res.cloudinary.com/dacfjv9vj/image/upload/v1646918208/zqzvtjdqt5inpecd3xfb.png'
    ...
    if (this.state.users.length > 0) {
      ...
      let newUserArr: any = this.state.users.filter((userobj: userDetails) => {
        if (userobj.email !== this.state.email) {
          return userobj;
        }
      })
        ...
        <header className="SignUp">
          ...
          <div className="row">
            <Table
              ...
              deleteAction={(userData: userDetails) => {
                const newUserArr: any = this.state.users.filter((userobj: userDetails) => {
                  return userobj.email !== userData.email
                })
                this.setState({
                  ...this.state,
                  ...this.initialState,
              ...
              editAction={(userData: userDetails) => {
                this.setState({
                  name: userData.name! || '',
